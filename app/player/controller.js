    ...
    checkout: async (req, res) => {
        try {
            ...
            if (!res_voucher)
                return res
                    .status(404)
                    .json({ message: 'Voucher tidak dapat digunakan' });
            ...
            if (!res_nominal)
                return res
                    .status(404)
                    .json({ message: 'Nominal tidak dapat digunakan' });
            ...
            if (!res_payment)
                return res
                    .status(404)
                    .json({ message: 'Payment tidak dapat digunakan' });
            ...
            if (!res_bank)
                return res
                    .status(404)
                    .json({ message: 'Bank tidak dapat digunakan' });
    ...
    historyDetail: async (req, res) => {
        try {
            ...
            if (!history)
                return res
                    .status(404)
                    .json({ message: 'History tidak ditemukan.' });
